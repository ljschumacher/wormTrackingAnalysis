function plotSampleHeadAngTraj(headAngRanges,featureToSample,numSampleTraj,wormcats,strain,wormnum)
...
% featureToSample: string specifying what is being sampled.
% 'headAngTotal','headAngNorm','headAngSpeed'.
...
%% import saved traj valuesgSpeed
headAngSampleTraj = importdata(['figures/turns/results/headAngSampleTraj_' strain '_' wormnum '.mat']);
...
for rangeCtr = 1:size(headAngRanges,1)
    for wormcatCtr = 1:length(wormcats)
        ...
        figurename = ['figures/turns/sampleTraj/' featureToSample '_' strain '_' wormnum '_' wormcats{wormcatCtr} '_range' num2str(rangeCtr)];
