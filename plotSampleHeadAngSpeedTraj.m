function plotSampleHeadAngSpeedTraj(headAngSpeedRanges,wormcats,numSampleTraj,strain,wormnum,marker,smoothing,frameRate)
...
for rangeCtr = 1:size(headAngSpeedRanges,1)
    for wormcatCtr = 1:length(wormcats)
        ...
        title([strain '\_' wormcats{wormcatCtr} ' sampleTraj, '...
            num2str(headAngSpeedRanges(rangeCtr,1)) '-' num2str(headAngSpeedRanges(rangeCtr,2)) 'radian/s'],'FontWeight','normal')
