...
%                 [x, y, u, v] = calculateWormSpeeds(trajData, frame, true);
...
%                     frameLogInd = trajData.frame_number==frame;
%                     ox = squeeze(skelData(1,1,frameLogInd) - skelData(1,2,frameLogInd));
%                     oy = squeeze(skelData(2,1,frameLogInd) - skelData(2,2,frameLogInd));
