...
for strainCtr = 1:length(strains)
    ...
    for numCtr = 1:length(wormnums)
        ...
        figurename = ['figures/reversalintertime_bodywall_' strains{strainCtr} '_' wormnum];
        ...
        figurename = ['figures/reversaldurations_bodywall_' strains{strainCtr} '_' wormnum];
    ...
    figurename = ['figures/reversalfrequency_bodywall_' strains{strainCtr}];
