...
% B and C. Script calculates cluster centroid speed and plots them as timeseries and box plot.
...
plotMeanSquaredDisplacement = true;
...
if plotCentroidSpeeds || plotMeanSquaredDisplacement
    ...
    plotFileList = [2,3,4,6]; % the replicates to plot for overall cluster speed - ignore rep 5 with two converging clusters
end
